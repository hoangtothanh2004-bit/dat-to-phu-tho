...
export function getOfficialDocxItinerary(): GeneratedItinerary {
  ...
  const lynnTimesStay: NearbyItem = {
    ...
    type: "stay",
    distance: "Trung tâm thị trấn Thanh Thủy",
    ...
    address: "Khu 2, Xã Bảo Yên (thị trấn Thanh Thủy), Tỉnh Phú Thọ",
  ...
  const day2Slots: ItinerarySlot[] = [
    ...
    },
    {
      ...
      type: "travel",
      activity: "Khởi hành rời Thanh Thủy, qua cầu Đồng Quang / cầu Văn Lang, theo tuyến Quốc lộ 2B vượt cung đèo thông reo uốn lượn hướng lên thị trấn mây Tam Đảo.",
      ...
      travelMinutes: 90,
      highlightNote: "Cung đường đèo mây ngoạn mục dẫn lên thị trấn trong sương",
      estimatedCostPerPerson: 0,
    },
    {
      period: "Sáng",
      ...
      transportAdvice: "Đậu xe tại bãi đỗ trung tâm thị trấn, tản bộ ngắm cảnh quanh quảng trường.",
      travelMinutes: 5,
      highlightNote: "Biểu tượng trung tâm thị trấn mây mù bồng bềnh (0đ)",
      estimatedCostPerPerson: 0,
    },
    {
      period: "Trưa",
    ...
    },
    {
      ...
      restaurant: {
        ...
        type: "restaurant",
        distance: "Khu 1, thị trấn Tam Đảo",
        ...
        address: "Khu 1, thị trấn Tam Đảo, Tỉnh Phú Thọ",
        hours: "09:00 – 22:30",
        phone: "0978 123 888",
        image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&auto=format&fit=crop&q=80",
      ...
      transportAdvice: "Nằm ngay khu ẩm thực trung tâm thị trấn, có chỗ đỗ xe thuận tiện.",
      travelMinutes: 5,
    ...
    },
    {
      ...
      restaurant: {
        ...
        address: "Dốc Cổng Trời, Khu 1, thị trấn Tam Đảo, Tỉnh Phú Thọ",
        hours: "07:00 – 23:00",
    ...
    },
    {
      ...
      transportAdvice: "Tản bộ quanh khu chợ truyền thống trung tâm thị trấn.",
      travelMinutes: 5,
    ...
    },
    {
      ...
      type: "visit",
      place: tamDaoPlace,
      activity: "Tự do lang thang qua những con dốc hoa sim tím, bậc thang đá phong cách châu Âu, lưu giữ những kỷ niệm đẹp cuối cùng tại thị trấn mây.",
    ...
    },
    {
      ...
      transportAdvice: "Tập trung tại bãi đỗ xe trung tâm thị trấn.",
      travelMinutes: 5,
